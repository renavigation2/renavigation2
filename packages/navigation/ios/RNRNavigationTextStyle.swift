struct RNRNavigationTextStyle {
    static func getStyles(_ styles: NSDictionary, defaultFontSize: CGFloat) -> [NSAttributedString.Key : Any] {
        getStyles(styles, defaultFontSize: defaultFontSize, defaultFontWeight: "normal")
    }

    static func getStyles(_ styles: NSDictionary, defaultFontSize: CGFloat, defaultFontWeight: String) -> [NSAttributedString.Key : Any] {
