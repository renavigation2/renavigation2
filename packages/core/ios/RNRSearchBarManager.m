...
RCT_EXPORT_VIEW_PROPERTY(selectedScopeBarButtonTitleStyle, NSDictionary)
RCT_EXPORT_VIEW_PROPERTY(reservedScopeBarButtonTitleStyle, NSDictionary)
RCT_EXPORT_VIEW_PROPERTY(highlightedScopeBarButtonTitleStyle, NSDictionary)
RCT_EXPORT_VIEW_PROPERTY(focusedScopeBarButtonTitleStyle, NSDictionary)
RCT_EXPORT_VIEW_PROPERTY(disabledScopeBarButtonTitleStyle, NSDictionary)
RCT_EXPORT_VIEW_PROPERTY(applicationScopeBarButtonTitleStyle, NSDictionary)
RCT_EXPORT_VIEW_PROPERTY(normalScopeBarButtonTitleStyle, NSDictionary)
